class AcessosApisController < ApplicationController
  before_action :set_acessos_api, only: %i[ show edit update destroy ]

  # GET /acessos_apis or /acessos_apis.json
  def index
    @acessos_apis = AcessosApi.all
  end

  # GET /acessos_apis/1 or /acessos_apis/1.json
  def show
  end
  ...
  def create
    ...
    respond_to do |format|
      if @acessos_api.save
        format.html { redirect_to acessos_api_url(@acessos_api), notice: "Acessos api was successfully created." }
  ...
  # PATCH/PUT /acessos_apis/1 or /acessos_apis/1.json
  def update
    respond_to do |format|
      if @acessos_api.update(acessos_api_params)
        format.html { redirect_to acessos_api_url(@acessos_api), notice: "Acessos api was successfully updated." }
  ...
  # DELETE /acessos_apis/1 or /acessos_apis/1.json
  def destroy
    @acessos_api.destroy
